 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FE{constructor(e,n,r){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=r,this.auth_=null,this.auth_=r.getImmediate({optional:!0}),this.auth_||r.onInit(s=>this.auth_=s)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(ke("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,r)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,r):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',Ue(e)}}class Po{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Po.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TC=!0;function pe(t,e=null){if(t===null)return R.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),E(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new ye(n,pe(e))}if(!(t instanceof Array)&&TC){const n=[];let r=!1;if(Te(t,(o,l)=>{if(o.substring(0,1)!=="."){const a=pe(l);a.isEmpty()||(r=r||!a.getPriority().isEmpty(),n.push(new U(o,a)))}}),n.length===0)return R.EMPTY_NODE;const i=fl(n,wC,o=>o.name,Pd);if(r){const o=fl(n,se.getCompare());return new R(i,pe(e),new Bt({".priority":o},{".priority":se}))}else return new R(i,pe(e),Bt.Default)}else{let n=R.EMPTY_NODE;return Te(t,(r,s)=>{if(It(t,r)&&r.substring(0,1)!=="."){const i=pe(s);(i.isLeafNode()||!i.isEmpty())&&(n=n.updateImmediateChild(r,i))}}),n.updatePriority(pe(e))}}EC(pe);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rd extends Ql{constructor(e){super(),this.indexPath_=e,E(!F(e)&&j(e)!==".priority","Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,n){const r=this.extractChild(e.node),s=this.extractChild(n.node),i=r.compareTo(s);return i===0?xr(e.name,n.name):i}makePost(e,n){const r=pe(e),s=R.EMPTY_NODE.updateChild(this.indexPath_,r);return new U(n,s)}maxPost(){const e=R.EMPTY_NODE.updateChild(this.indexPath_,zi);return new U(Dn,e)}toString(){return Ci(this.indexPath_,0).join("/")}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ii{constructor(e){this.indexedFilter_=new Ad(e.getIndex()),this.index_=e.getIndex(),this.startPost_=Ii.getStartPost_(e),this.endPost_=Ii.getEndPost_(e),this.startIsInclusive_=!e.startAfterSet_,this.endIsInclusive_=!e.endBeforeSet_}getStartPost(){return this.startPost_}getEndPost(){return this.endPost_}matches(e){const n=this.startIsInclusive_?this.index_.compare(this.getStartPost(),e)<=0:this.index_.compare(this.getStartPost(),e)<0,r=this.endIsInclusive_?this.index_.compare(e,this.getEndPost())<=0:this.index_.compare(e,this.getEndPost())<0;return n&&r}updateChild(e,n,r,s,i,o){return this.matches(new U(n,r))||(r=R.EMPTY_NODE),this.indexedFilter_.updateChild(e,n,r,s,i,o)}updateFullNode(e,n,r){n.isLeafNode()&&(n=R.EMPTY_NODE);let s=n.withIndex(this.index_);s=s.updatePriority(R.EMPTY_NODE);const i=this;return n.forEachChild(se,(o,l)=>{i.matches(new U(o,l))||(s=s.updateImmediateChild(o,R.EMPTY_NODE))}),this.indexedFilter_.updateFullNode(e,s,r)}updatePriority(e,n){return e}filtersNodes(){return!0}getIndexedFilter(){return this.indexedFilter_}getIndex(){return this.index_}static getStartPost_(e){if(e.hasStart()){const n=e.getIndexStartName();return e.getIndex().makePost(e.getIndexStartValue(),n)}else return e.getIndex().minPost()}static getEndPost_(e){if(e.hasEnd()){const n=e.getIndexEndName();return e.getIndex().makePost(e.getIndexEndValue(),n)}else return e.getIndex().maxPost()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class MC{constructor(){this.rootNode_=R.EMPTY_NODE}getNode(e){return this.rootNode_.getChild(e)}updateSnapshot(e,n){this.rootNode_=this.rootNode_.updateChild(e,n)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FC{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n=Object.assign({},e);return this.last_&&Te(this.last_,(r,s)=>{n[r]=n[r]-s}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const op=10*1e3,UC=30*1e3,zC=5*60*1e3;class VC{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new FC(e);const r=op+(UC-op)*Math.random();Ys(this.reportStats_.bind(this),Math.floor(r))}reportStats_(){const e=this.statsListener_.get(),n={};let r=!1;Te(e,(s,i)=>{i>0&&It(this.statsToReport_,s)&&(n[s]=i,r=!0)}),r&&this.server_.reportStats(n),Ys(this.reportStats_.bind(this),Math.floor(Math.random()*2*zC))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BS{constructor(e,n){this.committed=e,this.snapshot=n}toJSON(){return{committed:this.committed,snapshot:this.snapshot.toJSON()}}}function $S(t,e,n){var r;if(t=be(t),ra("Reference.transaction",t._path),t.key===".length"||t.key===".keys")throw"Reference.transaction failed: "+t.key+" is a read-only object.";const s=(r=void 0)!==null&&r!==void 0?r:!0,i=new hs,o=(a,u,d)=>{let h=null;a?i.reject(a):(h=new ls(d,new Dt(t._repo,t._path),se),i.resolve(new BS(u,h)))},l=gc(t,()=>{});return pS(t._repo,t._path,e,o,l,s),i.promise}Kt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};Kt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};WS();function sh(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(t);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(t,r[s])&&(n[r[s]]=t[r[s]]);return n}function Iv(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const HS=Iv,Nv=new ji("auth","Firebase",Iv());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */bn(sN,iN,"app");const oN={apiKey:"AIzaSyDJM-VHPdo2ipOFEecEFjxo5W_FQuQ3BAk",authDomain:"vistta-2e1df.firebaseapp.com",databaseURL:"https://vistta-2e1df-default-rtdb.firebaseio.com",projectId:"vistta-2e1df",storageBucket:"vistta-2e1df.firebasestorage.app",messagingSenderId:"13458811244",appId:"1:13458811244:web:e3517470970e9a45142b49",measurementId:"G-TJLG0CPZQM"},iy=c_(oN),Lo=nN(iy),Q=zS(iy),je=t=>Number(t||0).toLocaleString("pt-BR",{style:"currency",currency:"BRL"}),oy=P.createContext(null),Lt=()=>{const t=P.useContext(oy);if(!t)throw new Error("useAppContext deve ser usado dentro de um AppProvider");return t},lN=({children:t})=>{const[e,n]=P.useState(null),[r,s]=P.useState(!0),[i,o]=P.useState(null),[l,a]=P.useState(null),[u,d]=P.useState("dashboard"),[h,f]=P.useState(""),[_,v]=P.useState([]),[y,b]=P.useState([]),[g,m]=P.useState([]),[p,w]=P.useState([]),[C,N]=P.useState([]),[I,T]=P.useState([]),[G,M]=P.useState([]),[Qe,Hn]=P.useState([]),[qn,Qi]=P.useState([]),[pa,ws]=P.useState([]),[sn,S]=P.useState(""),[D,L]=P.useState("Pix"),[ne,de]=P.useState(0),Ce=P.useMemo(()=>C.find(A=>A.status==="aberto"),[C]),Nt=P.useMemo(()=>Ce?p.filter(A=>A.caixaId===Ce.id):[],[p,Ce]),Gn=P.useMemo(()=>Nt.reduce((A,W)=>A+(W.total||0),0),[Nt]),dt=()=>{if(!l)throw new Error("Empresa não identificada.");return l},Mt=async(A,W,he)=>{const ae=`empresas/${dt()}/${A}`;if(he){await vn(K(Q,`${ae}/${he}`),W);return}const ht=ei(K(Q,ae));await vn(K(Q,`${ae}/${ht.key}`),W)},ma=async(A,W)=>{const he=dt();await kS(K(Q,`empresas/${he}/${A}/${W}`))};P.useEffect(()=>Hk(Lo,A=>{A?gc(K(Q,`users/${A.uid}`),W=>{const he=W.val();he!=null&&he.empresaId&&(a(he.empresaId),o(he.role||"vendedor")),n(A),s(!1)}):(n(null),a(null),o(null),s(!1))}),[]),P.useEffect(()=>{if(!l)return;const A=`empresas/${l}`,W=new Date;W.setDate(1),W.setHours(0,0,0,0);const De=[{name:"produtos",setter:b,queryRef:K(Q,`${A}/produtos`)},{name:"clientes",setter:m,queryRef:K(Q,`${A}/clientes`)},{name:"fornecedores",setter:M,queryRef:K(Q,`${A}/fornecedores`)},{name:"contas",setter:Hn,queryRef:K(Q,`${A}/contas`)},{name:"categorias",setter:Qi,queryRef:K(Q,`${A}/categorias`)},{name:"usuarios",setter:ws,queryRef:K(Q,`${A}/usuarios`)},{name:"orcamentos",setter:T,queryRef:K(Q,`${A}/orcamentos`)},{name:"vendas",setter:w,queryRef:xp(K(Q,`${A}/vendas`),AS("data"),TS(W.toISOString()))},{name:"caixas",setter:N,queryRef:xp(K(Q,`${A}/caixas`),PS(100))}].map(ae=>gc(ae.queryRef,ht=>{const ft=[];ht.forEach(xs=>{ft.push({id:xs.key,...xs.val()})}),ae.setter(ft)}));return()=>De.forEach(ae=>ae())},[l]);const py={user:e,loadingAuth:r,userRole:i,empresaId:l,produtos:y,clientes:g,vendas:p,caixas:C,orcamentos:I,carrinho:_,fornecedores:G,contas:Qe,categorias:qn,usuarios:pa,activeTab:u,setActiveTab:d,pdvSearch:h,setPdvSearch:f,abrirCaixa:async A=>{if(Ce)throw new Error("Já existe um caixa aberto.");if(!Number.isFinite(A)||A<0)throw new Error("Informe um valor inicial válido.");await Mt("caixas",{dataAbertura:new Date().toISOString(),valorInicial:A,status:"aberto",operador:(e==null?void 0:e.email)||(e==null?void 0:e.uid)||"Operador"})},fecharCaixa:async()=>{if(!Ce)throw new Error("Nenhum caixa aberto.");await vn(K(Q,`empresas/${dt()}/caixas/${Ce.id}`),{status:"fechado",dataFechamento:new Date().toISOString(),totalVendas:Gn,valorFinal:Number(Ce.valorInicial||0)+Gn})},salvarProduto:(A,W)=>Mt("produtos",A,W),excluirProduto:A=>ma("produtos",A),salvarCliente:(A,W)=>Mt("clientes",A,W),excluirCliente:A=>ma("clientes",A),salvarCadastro:(A,W,he)=>Mt(A,W,he),excluirCadastro:(A,W)=>ma(A,W),addToCart:A=>{v(W=>{const he=W.findIndex(De=>De.id===A.id);if(he>-1){const De=[...W];return De[he].qtd=Math.min(De[he].qtd+1,Number(A.qtd)),De}return[...W,{...A,qtd:1}]})},removeFromCart:A=>v(W=>W.filter(he=>he.id!==A)),finalizarVenda:async(A=!1)=>{if(_.length===0||!l)return alert("Carrinho vazio!");if(!A&&!Ce)return alert("Abra o caixa primeiro!");let W=_.reduce((ae,ht)=>ae+Number(ht.venda)*ht.qtd,0),he=_.reduce((ae,ht)=>ae+Number(ht.custo)*ht.qtd,0),De=Math.max(0,Number(ne)||0);De=Math.min(De,W);try{if(A){if(!sn)return alert("Selecione um cliente para salvar o orçamento!");await ei(K(Q,`empresas/${l}/orcamentos`),{cliId:sn,subtotal:W,desconto:De,total:W-De,itens:_.map(ae=>({id:ae.id,marca:ae.marca,modelo:ae.modelo,qtd:ae.qtd,venda:ae.venda})),data:new Date().toISOString(),status:"pendente"})}else{const ae=_.map(async ft=>{const xs=K(Q,`empresas/${l}/produtos/${ft.id}/qtd`),yh=await kv(xs),ga=Number(yh.val());if(!yh.exists()||!Number.isFinite(ga)||ga<ft.qtd)throw new Error(`Estoque insuficiente para ${ft.marca} ${ft.modelo}.`);const _a=await $S(xs,Yi=>{if(Yi===null)return Yi;const wh=Number(Yi)-ft.qtd;return wh>=0?wh:Yi}),my=Number(_a.snapshot.val());if(!_a.committed||my!==ga-ft.qtd)throw new Error(`Não foi possível reservar o estoque de ${ft.marca} ${ft.modelo}.`);return _a});await Promise.all(ae);const ht=ei(K(Q,`empresas/${l}/vendas`));await vn(K(Q,`empresas/${l}/vendas/${ht.key}`),{cliId:sn,pag:D,subtotal:W,desconto:De,total:W-De,custoBase:he,itens:_.length,data:new Date().toISOString(),caixaId:Ce==null?void 0:Ce.id})}v([]),de(0),S(""),alert(A?"Orçamento salvo!":"Venda concluída com sucesso!")}catch(ae){alert("Erro ao finalizar: "+ae.message)}},caixaAberto:Ce,totalVendasCaixa:Gn,pdvCliente:sn,setPdvCliente:S,pdvDesconto:ne,setPdvDesconto:de,pdvPagamento:D,setPdvPagamento:L};return c.jsx(oy.Provider,{value:py,children:t})};/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const te=(t,e)=>{const n=P.forwardRef(({color:r="currentColor",size:s=24,strokeWidth:i=2,absoluteStrokeWidth:o,className:l="",children:a,...u},d)=>P.createElement("svg",{ref:d,...aN,width:s,height:s,stroke:r,strokeWidth:o?Number(i)*24/Number(s):i,className:["lucide",`lucide-${uN(t)}`,l].join(" "),...u},[...e.map(([h,f])=>P.createElement(h,f)),...Array.isArray(a)?a:[a]]));return n.displayName=`${t}`,n};/**
 * @license lucide-react v0.364.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
